...
selectedItems2: any[] = [];
 ...
 this.sortObject={
  sortBy:"",
  sortStatus:"",
searchBy:{govId:[],name:[],hospitalId:[],model:[],brandId:[],categoryId:[],orgId:[],subOrgId:[],subCategoryId:[],start:"",end:"",purchaseDateFrom:new Date(),purchaseDateTo:new Date()}
 }
...
this.data2.splice(index,1);
  ...
  highlightCoulmn(){
    ...
    //     const element = pageButtons[index].classList.remove('p-highlight');;
       
    //   }
    //   const pageButton1 = document.querySelector('.p-paginator-page[data-page="1"]');
    //   if (pageButton1) {
    //     pageButton1.classList.add('p-highlight');
    //   }
     
    // }
    // console.log( pageButtons[0]);
    this.pageNumber=1;
    this.pageSize=10;
  }
  onItemSelect(item: any) {
    ...
    this.eventclick.first=0;
    this.eventclick.rows=10;
